...
function setImgWithFallback(id, primarySrc, fallbackSrc){
  const img = $(id);
  if(!img) return;
  img.onerror = () => {
...
========================= */
function setQRs(){
setImgWithFallback('qrMenu', 'img/qr_menu.png', null);
setImgWithFallback('qrWapp', 'img/qr_wapp.png', null);
setImgWithFallback('qrIg',   'img/qr_inst.png', null);
