...
function popBadge(kind){
  // (se eliminó el badge de % descuento)
}
// (se eliminó el cálculo de % descuento)
function swapImage(src){
  const imgA = $("promoImgA");
  const imgB = $("promoImgB");

  // Sin transición cruzada: usamos siempre la capa A
  imgA.onerror = () => { imgA.src = "img/logo.png"; };
  imgA.src = src || "img/logo.png";
